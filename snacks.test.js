const { getInitials, createSlug, avarage, isPalidrome, findPostById } = require("./snacks.js");
...
//----------------------------------------SNACK 7--------------------------------------------//
const posts = [
  { id: 1, title: "Introduzione alla Programmazione", slug: "introduzione-alla-programmazione" },
  { id: 2, title: "Strutture Dati", slug: "strutture-dati" },
]


test(`La funzione findPostById restituisce il post corretto dato l'array di post e l'id`, () => {
   expect(findPostById(posts, 2)).toEqual({ id: 2, title: "Strutture Dati", slug: "strutture-dati" })
